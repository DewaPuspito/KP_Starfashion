...
<html lang="en">
  <head>
    ...
    <a class="navbar-brand" href="/fabric">StarFashion Maintenance</a>
            ...
            <tbody>
                @foreach($audits as $audit)
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('deletehistoryfabric', $audit->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
