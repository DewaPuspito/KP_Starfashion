...
<form action="/editfuse/{{$data_fuse->serial_number}}" method="POST" enctype="multipart/form-data">
  ...
  <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="jenis_sparepart_yang_diganti" class="form-control" value= "{{ $data_fuse ->jenis_sparepart_yang_diganti}}">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="number" name="harga_sparepart" class="form-control" value= "{{ $data_fuse ->harga_sparepart}}">
    </div>
